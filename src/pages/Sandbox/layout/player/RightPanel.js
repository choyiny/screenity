    ...
    <div className={styles.panel}>
      ...
      {contentState.mode === 'player' && (
        <div>
          ...
          {!contentState.fallback && contentState.updateChrome && !contentState.offline && contentState.duration <= contentState.editLimit && (
            <div className={styles.alert}>
              <div className={styles.buttonLeft}>
                <ReactSVG src={URL + 'editor/icons/alert.svg'} />
              </div>
          ...
          {!contentState.fallback && contentState.duration > contentState.editLimit && !contentState.override && !contentState.offline && !contentState.updateChrome && (
            <div className={styles.alert}>
              <div className={styles.buttonLeft}>
                <ReactSVG src={URL + 'editor/icons/alert.svg'} />
              </div>
            ...
            !contentState.noffmpeg && (
              <div className={styles.alert}>
                ...
                <div className={styles.buttonMiddle}>
                  ...
                  <div className={styles.buttonDescription}>{chrome.i18n.getMessage('videoProcessingLabelDescription')}</div>
                </div>
                <div
                  className={styles.buttonRight}
                  onClick={() => {
          ...
          <div className={styles.section}>
            ...
            <div className={styles.buttonWrap}>
              <div
                ...
                onClick={handleEdit}
                disabled={(contentState.duration > contentState.editLimit && !contentState.override) || !contentState.mp4ready || contentState.noffmpeg}
              >
                <div className={styles.buttonLeft}>
                ...
                <div className={styles.buttonMiddle}>
                  ...
                  <div className={styles.buttonDescription}>
                    {contentState.offline && !contentState.ffmpegLoaded
                      ...
                      : contentState.updateChrome || contentState.noffmpeg || (contentState.duration > contentState.editLimit && !contentState.override)
          ...
          <div className={styles.section}>
            ...
            <div className={styles.buttonWrap}>
              {contentState.fallback && (
                <div role="button" className={styles.button} onClick={() => contentState.downloadWEBM()} disabled={contentState.isFfmpegRunning}>
                  <div className={styles.buttonLeft}>
                    <ReactSVG src={URL + 'editor/icons/download.svg'} />
                  </div>
                  <div className={styles.buttonMiddle}>
                    <div className={styles.buttonTitle}>{contentState.downloadingWEBM ? chrome.i18n.getMessage('downloadingLabel') : chrome.i18n.getMessage('downloadWEBMButtonTitle')}</div>
                    <div className={styles.buttonDescription}>{chrome.i18n.getMessage('downloadWEBMButtonDescription')}</div>
                  </div>
                  <div className={styles.buttonRight}>
                    <ReactSVG src={URL + 'editor/icons/right-arrow.svg'} />
                  </div>
              ...
              <div
                ...
                disabled={contentState.isFfmpegRunning || contentState.noffmpeg || !contentState.mp4ready || contentState.noffmpeg}
              >
                <div className={styles.buttonLeft}>
                  <ReactSVG src={URL + 'editor/icons/download.svg'} />
                </div>
                <div className={styles.buttonMiddle}>
                  <div className={styles.buttonTitle}>{contentState.downloading ? chrome.i18n.getMessage('downloadingLabel') : chrome.i18n.getMessage('downloadMP4ButtonTitle')}</div>
                  <div className={styles.buttonDescription}>
                    {contentState.offline && !contentState.ffmpegLoaded
                      ? chrome.i18n.getMessage('noConnectionLabel')
                      : contentState.updateChrome || contentState.noffmpeg || (contentState.duration > contentState.editLimit && !contentState.override)
              ...
              {!contentState.fallback && (
                <div role="button" className={styles.button} onClick={() => contentState.downloadWEBM()} disabled={contentState.isFfmpegRunning}>
                  ...
                  <div className={styles.buttonMiddle}>
                    <div className={styles.buttonTitle}>{contentState.downloadingWEBM ? chrome.i18n.getMessage('downloadingLabel') : chrome.i18n.getMessage('downloadWEBMButtonTitle')}</div>
                    <div className={styles.buttonDescription}>{!contentState.isFfmpegRunning ? chrome.i18n.getMessage('downloadWEBMButtonDescription') : chrome.i18n.getMessage('preparingLabel')}</div>
                  </div>
                  <div className={styles.buttonRight}>
                    <ReactSVG src={URL + 'editor/icons/right-arrow.svg'} />
                  </div>
              ...
              {!contentState.fallback && (
                <div role="button" className={styles.button} onClick={() => contentState.downloadTranscript()} disabled={contentState.isFfmpegRunning}>
                  <div className={styles.buttonLeft}>
                    <ReactSVG src={URL + 'editor/icons/download.svg'} />
                  </div>
                  <div className={styles.buttonMiddle}>
              ...
              <div
                ...
                disabled={contentState.isFfmpegRunning || contentState.duration > 30 || !contentState.mp4ready || contentState.noffmpeg}
              >
                <div className={styles.buttonLeft}>
                  <ReactSVG src={URL + 'editor/icons/gif.svg'} />
                </div>
                <div className={styles.buttonMiddle}>
                  <div className={styles.buttonTitle}>{contentState.downloadingGIF ? chrome.i18n.getMessage('downloadingLabel') : chrome.i18n.getMessage('downloadGIFButtonTitle')}</div>
                  <div className={styles.buttonDescription}>
                    {contentState.offline && !contentState.ffmpegLoaded
                      ? chrome.i18n.getMessage('noConnectionLabel')
                      : contentState.updateChrome || contentState.noffmpeg || (contentState.duration > contentState.editLimit && !contentState.override)
            ...
            <div className={styles.buttonWrap}>
              ...
              >
                ...
                <div className={styles.buttonMiddle}>
                  ...
                  <div className={styles.buttonDescription}>{chrome.i18n.getMessage('rawRecordingButtonDescription')}</div>
                </div>
                <div className={styles.buttonRight}>
                  <ReactSVG src={URL + 'editor/icons/right-arrow.svg'} />
                </div>
              ...
              >
                ...
                <div className={styles.buttonMiddle}>
                  ...
                  <div className={styles.buttonDescription}>{chrome.i18n.getMessage('troubleshootButtonDescription')}</div>
                </div>
                <div className={styles.buttonRight}>
                  <ReactSVG src={URL + 'editor/icons/right-arrow.svg'} />
                </div>
